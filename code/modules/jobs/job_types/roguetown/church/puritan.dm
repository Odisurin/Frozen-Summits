/datum/job/roguetown/puritan
	...
	tutorial = "You worship and pay credence to the old god, itharoth--in heretical contrast to the church of the Ten. However, both the crown and church have emboldened your radical sect. Your fervor allows you to root out cultists, the cursed night beasts, and other agents of the darkness using your practice of extracting involuntary 'sin confessions.' Remember, though; they tolerate you only so long as you have a common enemy..."
	whitelist_req = TRUE

	outfit = /datum/outfit/job/roguetown/puritan
	display_order = JDO_PURITAN
	give_bank_account = 36
	min_pq = 0 //Only for those bold of spirit, sure of mind, hard of pintle...and should probably know itharoth from Zizo. Not a crucial role, and rather prone to people instigating excessive conflict
	max_pq = null
